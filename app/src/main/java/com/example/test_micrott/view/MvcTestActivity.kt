...
// =====================================================================
// day3：在 Activity 门外，并排贴上今天独立的九宫格渲染适配器
//底层物理隔离，百分之百切断对 Activity 的隐式持有，实现工业级零内存泄漏。
// =====================================================================
class ImageGridAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    fun updateData(images: ArrayList<Uri>) {
        this.mSelectedImages = images
        notifyDataSetChanged()
    }

    override fun getItemCount(): Int {
        // 核心动态策略：如果没选满 9 张，长度永远是图片数 + 1（把加号挂在队尾）
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        // 修正原先的打字笔误，这里直接用标准的 Kotlin 关键字 is 判断类型
